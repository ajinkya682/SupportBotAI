 ...
 * No component should ever read import.meta.env directly — import from here instead.
 */
...
export const SUPER_ADMIN_EMAIL = import.meta.env.VITE_SUPER_ADMIN_EMAIL || 'superadmin@gmail.com';
