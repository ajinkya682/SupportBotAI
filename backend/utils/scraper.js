...
// Named constants — read from environment with sensible defaults
const MAX_PAGES = parseInt(process.env.SCRAPER_MAX_PAGES) || 8;
const DELAY_MS = parseInt(process.env.SCRAPER_DELAY_MS) || 1000;
const MAX_CHARS = parseInt(process.env.KNOWLEDGE_MAX_CHARS) || 8000;
const USE_PUPPETEER = process.env.SCRAPER_USE_PUPPETEER !== 'false'; // defaults to true
const RAW_TEXT_MAX = 15000;
